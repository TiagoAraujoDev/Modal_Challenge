<h1 align="center">Modal practice</h1>
<p align="center">challenge to make a modal.</p>
...
- Apply my knowledge in HTML, CSS and Javascript to make a modal. In this challenge I learned about event.key to be able to make a function that is only invoked when the key b is press, but I used a conditional to only invoke it when the button is set with class modal-open in this way it isn't invoked all the time.
